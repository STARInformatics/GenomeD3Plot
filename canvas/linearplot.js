////////////////////////////////////////////////
//
// Linear Plot/Genome Track Initialization
//
////////////////////////////////////////////////
...
function genomeTrack(layout,tracks) {
    ...
    this.zoom = d3.behavior.zoom()
	   .x(this.x1)                                                                // TODO SCALE passed into a SCALE?
    ...
    // TODO clear any previous renderings?
    d3.select(layout.container).select("svg").remove();

    // TODO transform SVG Initialization into canvas initialization
    ...
    for(var i=0; i < this.tracks.length; i++) {
      ...
      // TODO: Refactor the conditionals within this switch method
      // TODO: merge with the redraw function? separate out the creaction from redraw?


    	switch(this.tracks[i].trackType) {
      	case "gap":
          // TODO: Why no conditional guarding here?
          ...
          if('undefined' !== typeof this.tracks[i].linear_skipInit && this.tracks[i].linear_skipInit) {
    	    ...
    	    break;
      	case "glyph":
            // TODO: Why extended guarding here?
      	    ...
      	    break;
      	case "plot":
            // TODO: why both tracks and itemRects
...
// TODO: Geometry drawn here?
// TODO: How much of these principles between functions are shared?
